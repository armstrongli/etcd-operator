...
type ClusterStatusApplyConfiguration struct {
	Phase          *etcdv1beta2.ClusterPhase            `json:"phase,omitempty"`
...
func (b *ClusterStatusApplyConfiguration) WithPhase(value etcdv1beta2.ClusterPhase) *ClusterStatusApplyConfiguration {
	b.Phase = &value
	return b
}
