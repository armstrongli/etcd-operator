...
// MembersStatusApplyConfiguration represents a declarative configuration of the MembersStatus type for use
// with apply.
...
// MembersStatusApplyConfiguration constructs a declarative configuration of the MembersStatus type for use with
// apply.
