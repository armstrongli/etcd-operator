...
// MemberSecretApplyConfiguration represents a declarative configuration of the MemberSecret type for use
// with apply.
...
// MemberSecretApplyConfiguration constructs a declarative configuration of the MemberSecret type for use with
// apply.
