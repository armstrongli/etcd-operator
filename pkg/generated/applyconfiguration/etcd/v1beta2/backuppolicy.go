...
// BackupPolicyApplyConfiguration represents a declarative configuration of the BackupPolicy type for use
// with apply.
...
// BackupPolicyApplyConfiguration constructs a declarative configuration of the BackupPolicy type for use with
// apply.
