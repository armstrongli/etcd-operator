...
// PodPolicyApplyConfiguration represents a declarative configuration of the PodPolicy type for use
// with apply.
...
// PodPolicyApplyConfiguration constructs a declarative configuration of the PodPolicy type for use with
// apply.
