...
// StaticTLSApplyConfiguration represents a declarative configuration of the StaticTLS type for use
// with apply.
...
// StaticTLSApplyConfiguration constructs a declarative configuration of the StaticTLS type for use with
// apply.
